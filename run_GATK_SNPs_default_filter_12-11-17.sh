...
-V /n/home15/elmoremh/regal_mhelmore/alignment_array/GATK/vcf/AmanitaBASE_raw_snps_12-11-17.vcf \
--filterExpression "QD < 2.0 || FS > 60.0 || MQ < 40.0 || MQRankSum < -12.5 || ReadPosRankSum < -8.0" \
--filterName "default_parameters" \
-o /n/home15/elmoremh/regal_mhelmore/alignment_array/GATK/filtering/AmanitaBASE_SNPs_default_filter_12-11-17.vcf
