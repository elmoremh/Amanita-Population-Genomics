#!/bin/bash
#SBATCH -J trimgalore_AHMC7TBCXX_10-11-16
#SBATCH -n 8 # Number of cores requested 
#SBATCH -t 200 # Runtime in minutes 
#SBATCH -p serial_requeue # Partition to submit to 
#SBATCH --mem=16000 
#SBATCH -o /n/regal/haig_lab/mhelmore/Illumina_data/trimmmed_reads/trimgalore/10-11-16/logs/trimgalore_AHMC7TBCXX_10-11-16.out # Standard out goes to this file 
#SBATCH -e /n/regal/haig_lab/mhelmore/Illumina_data/trimmmed_reads/trimgalore/10-11-16/logs/trimgalore_AHMC7TBCXX_10-11-16.err # Standard err goes to this filehostname
...
~/sw/trim_galore \
--paired --retain_unpaired --phred33 --illumina --length 36 -q 20 --stringency 1 -e 0.1 \
--fastqc --fastqc_args "--outdir /n/regal/haig_lab/mhelmore/Illumina_data/fastqc_trimmed/trimgalore/10-9-16" \
--output_dir /n/regal/haig_lab/mhelmore/Illumina_data/trimmmed_reads/trimgalore/10-11-16 \
